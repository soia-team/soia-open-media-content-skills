...
| [`soia-media-generate-article-image`](./soia-media-generate-article-image/) | 为文章生成封面、正文小结卡、学习笔记图和视觉隐喻海报 | Use $soia-media-generate-article-image to select an article-image preset, save the prompt, generate a real bitmap, and verify it visually. |
