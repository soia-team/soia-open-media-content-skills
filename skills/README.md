...
| [`soia-media-generate-article-image`](./soia-media-generate-article-image/) | 生成文章图片、技能库宣传卡和可核验的社交媒体轮播 | Use $soia-media-generate-article-image to select a preset, ground facts, generate the visual, and verify the final bitmap and exact text. |
