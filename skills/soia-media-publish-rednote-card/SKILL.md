...
updated_at: 2026-08-08 00:55:00
...
小红书图文笔记正文上限 1000 字。原稿超限时**不要硬删成摘要完事**，按「文字卡承载全文」的长文形态处理：
...
- **两条路线分工**：热点快打（当天时效）可直接用小红书 App 自带文字模板人工发布，速度优先、不进产线；系列常青文与需要跨平台复用（公众号/X 重排）的长文才走上述自产卡路线。
