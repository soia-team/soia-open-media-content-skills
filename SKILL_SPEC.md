...
`soia-open-media-content-skills` and `soia-private-skills` intentionally use the same template
...
- `hard` / `optional` list SOIA-managed skill names only (published from
  soia-open-media-content-skills or soia-private-skills).
...
format and is intentionally absent from `soia-open-media-content-skills`.
