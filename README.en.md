...
Reusable AI skills for article writing, article-image generation, content adaptation, and draft delivery across WeChat, X, and Rednote.
...
| `soia-media-generate-article-image` | Generate article covers, editorial summary cards, Cornell-note infographics, and visual-metaphor posters from extensible templates. |
