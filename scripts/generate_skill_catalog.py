...
def resolve_repo_name(root: Path) -> str:
    ...
    # https://github.com/soia-team/soia-open-media-content-skills.git  -> soia-open-media-content-skills
    # git@github.com:soia-team/soia-open-media-content-skills.git       -> soia-open-media-content-skills
    tail = url.rstrip("/")
    for sep in ("/", ":"):
        if sep in tail:
